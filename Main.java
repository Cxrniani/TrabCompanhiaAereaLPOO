...
public class Main {
	...
	public static void main(String args[]) {
		...
		try {
			...
			// adiciona diferença nos horários de partida e chegada (só pra ficar mais
			// realista)
			hdestino1.add(Calendar.HOUR, 10);
			hdestino2.add(Calendar.HOUR, 15);
			hdestino3.add(Calendar.HOUR, 13);
			hdestino4.add(Calendar.HOUR, 12);
			horigem2.add(Calendar.HOUR, 5);
			horigem3.add(Calendar.HOUR, 7);
			horigem4.add(Calendar.HOUR, -4);
			...
			Passageiro p1 = new Passageiro("Zeca Pagodinho", "12345678911", "1231241", e1, "6799922222", "18/12/2002",
					"102345");
			Passageiro p2 = new Passageiro("Fulano Silva", "87654321111", "567890", e2, "6799888888", "25/05/1990",
					"567890");
			...
			Passageiro p4 = new Passageiro("Ciclano Oliveira", "34127856111", "456789", e4, "6799666666", "02/09/1995",
					"456789");
			Passageiro p5 = new Passageiro("Maria Santos", "78901234111", "654321", e5, "6799555555", "14/07/1978",
					"654321");
			Passageiro p6 = new Passageiro("João Pereira", "12309876111", "789012", e6, "6799444444", "20/03/2000",
					"789012");
			Passageiro p7 = new Passageiro("Ana Silva", "56789012111", "210987", e2, "6799333333", "05/08/1987",
					"210987");
			Passageiro p8 = new Passageiro("Carlos Rocha", "87654301111", "109876", e4, "6799222222", "10/02/1998",
					"109876");
			...
			System.err.println("Valor inserido não é valido.");
		} finally {
			sc.close();
		}
	}
